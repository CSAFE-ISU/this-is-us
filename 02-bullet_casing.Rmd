...
#### The regions to annotate are as follows: 
  ...
  1. Groove engraved areas are painted dark blue for the $\color{blue}{\text{left groove}}$ and neon green for the $\color{#00ff00}{\text{right groove}}$.
  2. $\color{#ff0080}{\text{Break-off Region}}$, located at the bottom heel of a scan are painted in pink.
  3. $\color{grey}{\text{Damaged Regions}}$  are painted using the color white.
  4. $\color{#66ffff}{\text{Areas without Striations}}$ marks are painted in light blue. 
  5. Striation marks with a secondary pattern are painted in light yellow $\color{yellow}{\text{********}}$. 
  6. Finally, all areas with $\color{#cd7f32}{\text{well expressed striation marks}}$ are left unpainted.
  7. $\color{#000000}{\text{Missing Values}}$ in a LEA scan are painted Black
