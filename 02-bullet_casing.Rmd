...
```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/show_and_tell_3.png"))
```
...
```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/Missing_Values_Interpolation_Facet_2.png"))
```

```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/Missing_Values_Interpolation_1.png", "images/andy_temp/Missing_Values_Interpolation_3.png"))
```
...
```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/csafe_21_noNA_x3p.png"))
```

```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/csafe_21_nostriae_2.png", "images/andy_temp/csafe_21_vert_2.png", "images/andy_temp/csafe_21_groove_2.png"))
```
...
```{r, fig.cap="Title coming soon.", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/andy_temp/ResNet_3D_CNN_Performance.png"))
```
