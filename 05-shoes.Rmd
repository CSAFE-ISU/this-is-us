...
4. Create a new mask to sample the image (and the mask) radially.     
<img src="images/shoes/longitudinal/Templates_Radial_Mask_Single.png" width = "30%"/>    
...
<img src="images/shoes/longitudinal/Templates_Radial_Mask_Multiple.png" width = "100%"/>   

5. Brute force for finer alignment.
