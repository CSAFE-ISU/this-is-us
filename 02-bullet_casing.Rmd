...
Next, we take each x3p file containing a masked LEA scan, crop, and store each 128x128 resolution grid of the original scan as a new x3p.
...
See how the parameter (bulletxtrctr::x3p_crosscut_optimize()) selection will affect the crosscut locations. It is clear that the larger the "distance" the higher position the crosscut is located.

```{r, fig.cap="Boxplot: compare the crosscut locations for distance set as 10 and 15", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/compare-cc-fig1.png"))
```

```{r, fig.cap="Scatter plot: compare the crosscut locations for distance set as 10 and 15", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/compare-cc-fig2.png"))
```
