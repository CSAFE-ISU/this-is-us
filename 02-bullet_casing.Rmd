...
### Probabilistic deep learning Exploration

```{r, fig.cap="Output Probabilites from sections of LEA", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Probabilistic_DL_Models_1.png"))
```
