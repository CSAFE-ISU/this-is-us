...
<details>
<summary>
Will 02/07 Update: In the past week I mainly focused on the writing. Now we are making revisions paragraph by paragraph, adding figure captions, and adding citations.
...
Crosscut locations for 325 "bad" LEAs with Will's app. They are all really bad LEAs, and if there is a screening procedure, these might be those to be excluded. A "special" one as shown in the following:
