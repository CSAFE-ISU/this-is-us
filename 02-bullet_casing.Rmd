...
<details>
<summary>
Joe 6/1 Update: I've been writing the R Journal submission and adding more functionality to the cmcR package in the last few weeks. I believe we are close to finishing the R Journal submission and are on the home stretch for finishing the cmcR package.
</summary>

I have been working on a lot of the "boring" parts of package writing including adding some functionality, writing tests, and improving documentation. Writing has also taken up a considerable amount of time. For those of you who are new, I thought I would share some exposition for my project and discuss its current condition.
...
knitr::include_graphics("images/cartridge_cases/5-28_update/knmCMCs.png", dpi = 100)
```

As I said above, we are close to finishing the R Journal submission as well as the development of the cmcR package. I'm very excited to delve into *new* ideas that we have for the project and will hopefully have thoughts to share on this in the future.
...
## Research Plan Summer

1. Trust model
2. User study design
3. JSM - Bullet scoring - Adapted Chumbley
