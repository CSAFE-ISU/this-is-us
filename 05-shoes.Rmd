...
Analysis setup:
   ...
   -Person: Person 1 (weight aa lb)and person 2 (bb lb)
   -Weights: 2 weight vests (20 lbs and 12 lbs)
   -Weight variations: W1(A), W2(P1 with one vest), W3(P1 with two vests), W4(B), W5(P2 with one vest), W6(P2 with two vests)
