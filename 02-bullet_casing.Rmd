...
```{r}
knitr::include_graphics("images/cartridge_cases/5-28_update/kmCMCs.png")
```

In contrast, the plots below show the results from a comparison between two known *non*-match cartridge case scans.

```{r}
knitr::include_graphics("images/cartridge_cases/5-28_update/knmCMCs.png")
```
