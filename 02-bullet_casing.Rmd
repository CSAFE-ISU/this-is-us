...
```{r}
include_graphics("images/cartridge_cases/highlyCorrelatedCellPair_largeProportionOfImage")
```
...
```{r}
include_graphics("images/cartridge_cases/highlyCorrelatedCellPair_smallProportionOfImage")
```
...
```{r}
include_graphics("images/cartridge_cases/lowCorrelatedCellPair_largeProportionOfImage")
```
