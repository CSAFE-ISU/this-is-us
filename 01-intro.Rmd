...
In order to refer to any papers you are using in your research (or have written yourself), we use the bibtex format. 
All of our references are included in the file [book.bib](book.bib).
For example, the bibtex entry for the paper on how the matching algorithm for bullets performs on degraded lands, is:
