...
3. Create a local copy of the [this-is-us repository](https://github.com/CSAFE-ISU/this-is-us) on your machine:

  Step 0: Copy the text underneath the green button on the right hand side:
    ![](images/setup/00_copy-github.png)
  Step 1: Open RStudio and create a new project: New Project > Version Control > Git
    ![](images/setup/00_create-project.png)
    ![](images/setup/01_create-project.png)
    Now paste the text from the clipboard into the url:
    ![](images/setup/02_create-project.png) 
...
4. And finally, the RStudio project opens in your local this-is-us folder:

![](images/setup/04_create-project.png)

I am assuming that you have set up git in Rstudio. If not, read the start of Jenny Bryan's chapter [Can you hear me now?](https://happygitwithr.com/connect-intro.html) of her book "Happy Git with R".
...
## Where should I make changes?
 ...
 `bookdown` projects such as ours are organized by chapter: each chapter is in a separate Rmd file of the form `xx_csafe-project-name.Rmd`, where `xx` is a number (corresponding to the chapter number). Pick the Rmd file that best describes your project and make changes there.
If you can't see your work in any of the projects, please let us know!
