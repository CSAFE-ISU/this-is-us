...
### 5.3.6 Regression Methods to Analyze Demographic Features with Respect to Handwriting Slant
...
 Due to sample size, we did not include region in the models, and we combined age groups of 18-40 and all ages above 41+ for analysis. Later we 
...
Some observed data summaries are shown to the for the 8 most populated clusters of graphs.
...
```{r}
knitr::include_graphics(c("images/handwriting/anyeshameanval.png"))
```
...
Next step will be to conduct a model comparison between the first 140 writers and a new batch of 100 writers. 
