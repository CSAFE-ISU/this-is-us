...
2. Gross align the non-background pixels in the image and mask
    ...
    - <span class="new">Alignment method options:
...
Image-to-image alignment requires more work. 
...
The alignment process itself (without any image preprocessing) is extremely fast, about 1s per image pair, and seems to be similar even when image size is increased by a factor of 16. 
...
**Updated visualization of aggregated predictions**
...
|---------------------|-----------------|--------------------|------------------|
| 'Before' Pictures   | 4 per shoe      | 15 per shoe        | 5 per shoe       |
| Paper               | Letter (larger) | Tape 8.5 x 11      | Tape 8.5 x 11    |
|                     |                 |                    |                  |
| Actions             | Run, jump, walk | Step, hop          | Step, hop        |
| Replicates          | 6 per shoe      | 9 per shoe         | 6 per shoe       |
| 'After' Pictures    | 1 pic per print | 3 pics per print   | 1 pic per print  |
|                     |                 |                    |                  |
| Total number prints | 18 per shoe     | 18 per shoe        | 12 per shoe      |
| Total number images | 18 per shoe     | 54 per shoe        | 12 per shoe      |
...
- Ask for 6 replicates per shoe, like Leverhulme
    - Analysis ramifications?
