...
Assume beta distributions for the ccf for both known mathces and known non-matches. For the real known match cases, we consider a mixture distribution of two beta distribution.

I'm working on those concepts mixture model, mixture distribution, beta-mixture model, mixture beta regression. And try to fit the model by R packages: mixtools, flexmix, betareg. I'm trying to find a way using the above mentioned methods and packages.

```{r, fig.cap="beta mixture fit seperately", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/betafit3.PNG"))
```

```{r, fig.cap="beta mixture fit including some prior information", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/betafift2.PNG"))
```

```{r, fig.cap="beta mixture fit for land-land KM", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/landp1.PNG"))
```

```{r, fig.cap="beta mixture fit for land-land KNM and KM comp1", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/landp2.PNG"))
```

```{r, fig.cap="log-likelihood ratio for KNM and KM", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/knm-km-entire.PNG"))
```

```{r, fig.cap="log-likelihood ratio for KNM and KM_Comp2", out.width="50%", fig.keep="hold", fig.align='center'}
include_graphics(c("images/yawei/knm-km-comp2.PNG"))
```
#### follow-up study 
...
<p class="new"> We are adding more operators to our variability study! </p>

<p class="new"> I have been working on book edits this week as well. :) </p>
