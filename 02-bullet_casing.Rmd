...
<details>
<summary>
Will 06/27 Update: we defined new metric based on CMPS scores and introduced the scaled version of the CMPS score. We applied ANOVA on the CMPS metrics generated by scaled CMPS scores to compute an F-statistic as a measurement of the separation between KM and KNM groups.
</summary>
...
*   the scaled CMPS score $c_{ij}^*$ is the original CMPS score $c_{ij}$ divided by the number of basis segments $l_{ij}$ (the highest possible CMPS score) of the comparison between $i$ and $j$.

$$
c_{ij}^* = \frac{c_{ij}}{l_{ij}}
$$

*   we use one-way ANOVA to compute the variance ratio
...
```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Left_Groove_1-100_pointplot.png"))
```

```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Right_Groove_1-100_pointplot.png"))
```

```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/damage_1-100_pointplot.png"))
```

```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/No_Striations_1-100_pointplot.png"))
```

```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/vertical_change_in_striations_1-100_pointplot.png"))
```

```{r, fig.cap="Scatterplot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/breakoff_1-100_pointplot.png"))
```
