...
<p class="new"> We are using few resources to conceptualize and plan the pipeline work, including: </p>  
...
<p class="new"> We are also investigating the variability of random forest scores, using pairs of signatures. The current process for taking a set of signatures and completing pairwise comparisons on each of them actually completes many comparisons twice, which has two impacts: </p>  
...
I also have been working on finishing up "ground truth ID's" for the variability study, and editing my joint paper with Nate.  
