...
```{r, fig.cap="An example of a side-view of a cartridge case and associated kernel density estimation.", out.width="50%", fig.keep="hold", fig.align='center',fig.show='hold'}
knitr::include_graphics(c("images/cartridge_cases/rowSum_kdeComparison.png"))
```
