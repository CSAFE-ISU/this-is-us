...
$$
\text{logit}(p_{i,j,[k,l]}) = \alpha_0 + \alpha_i + \alpha_j + \gamma_{ij} + f_u(u_i) + f_u(u_j) + f_s(s_{[k,l]}).
$$
...
Assume that the sites $\pmb{s} = (s_{[k,l]})$ follow a "Besag" distribution defined by
$$
s_{[k,l]} | \pmb{s}_{-[k,l]}, \tau_s \sim N\left(\frac{1}{n_{[k,l]}} \sum_{[k,l] \sim [m,n]} s_{[m,n]}, \frac{1}{n_{[k,l]} \tau_s}\right)
$$
...
* Manage to submit the `cmpsR` package to CRAN
