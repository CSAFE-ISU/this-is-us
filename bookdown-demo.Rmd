...
<p class="new"> Two papers in progress! Groove ID paper #1 is waiting for reviewer scores, Groove ID paper #2 is waiting for advisor comments. </p>
...
<p class="new"> I am in a mad dash to get more book content to Alicia and then reviewers soon. </p>  
...
<details>
<summary>
Joe 10/24/18 Update: Finished computing (almost) all 780 possible known match and known non-match comparisons for the 40 cartridge case scans discussed in the Tong paper. It certainly appears that we have qualitatively similar results to what they provide. I am also working on writing up a vignette that discusses how to use the package.
</summary>
...
<!--chapter:end:02-bullet_casing.Rmd-->
...
<p class="new">Data collection is underway with the most recent update (10/3):<p>

  - 88 complete through session #3
  - 11 complete through session #2
  - 12 complete through session #1

As of September 2019, Marc and Anyesha are the primary contacts for the study.

<p class="new"> An article for [Data in Brief](https://www.journals.elsevier.com/data-in-brief) will be drafted this semester. Authors: Anyesha Rey, Amy Crawford, Alicia Carriquiry.<p>
...
We are currently working to incorporate the cluster grouping assignments into the package. This will be complete pending creation of a template. <p class="new">Code is running on the `csafe-01` server for template creation. <p>

## Statistical Analysis
### Clustering

 
Paper submitted (September 2019)!
...
#### Model #2, Mixture{-}
<p class = "new"> There seem to be greatly varying shapes in the relative frequency of cluster fill. We think maybe a more flexible Dirichlet distribution is warranted.<p>
...
<p class="new">This has been resolved (?) by placing constraints on the first three elements of $\alpha$ and $\beta$ with moderately informative priors. <p>
...
- <strong>"A Database of Handwriting Samples for Applications in Forensic Statistics"</strong>
    ...
    - In preparation for submission to Data in Brief
...
<!--chapter:end:03-handwriting.Rmd-->
...
- Presented on CoNNOR at [ISU's 3-Minute Thesis competition](https://www.grad-college.iastate.edu/three-minute-thesis/)
    ...
    - Winner of each heat (announced today by 5 pm) will go on to finals next week
...
- Improving spatial integration process
    ...
    - Discovered bug this morning. Pictures coming soon!
...
- Ask volunteers to test procedure by Monday, November 4th
    - I believe Heike volunteered her children, and Joe reluctantly agreed to help. Anyone else? Pretty please? :D
- Ask Leverhulme how they use their data, what changes they would make, etc. First, currently checking with James to see if he already has this info.
- Talk to Alicia about how (or whether) CSAFE plans to use the data in any specific ways, to make sure procedure pruning doesn't impede analysis
...
**ROC curves on test comparisons**:
<img src="images/shoes/Features/ROC_allfeatures.png" width="100%"/>


**ROC curves when Q is degraded**:
<img src="images/shoes/Features/ROC_deg10.png" width="100%"/>
...
<!--chapter:end:06-theoretical_foundation.Rmd-->
