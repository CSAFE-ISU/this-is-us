...
A couple of problems worth noting are that:

* The Hough process has trouble detecting slanted lines in the z-direction
...
```{r eval = FALSE,echo=TRUE}
head(km1_unknown1_comparison$comparison_1to2$ccfResults$`21`,10)
```
