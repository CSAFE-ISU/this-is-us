...
knitr::include_graphics("images/bullets/Hough_project/images/bullets/Hough_project/preliminary_phoenix_score_results_right.png")
```
...
- <p class="new"> "A non-parametric test for matching bullet striations: extending the chumbley score for bullet-to-bullet matching </p>
    - July 2019 
