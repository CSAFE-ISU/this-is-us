...
\begin{align*}
\mathbb{I}(H_{x};\delta) - \mathbb{I}(H;\delta) 
&= \begin{multlined}[t] \mathbb{H}(H|A) - \mathbb{H}(H|\delta, A) - \\
\left[ \mathbb{H}(H) - \mathbb{H}(H|\delta) \right] 
\end{multlined} \\
&= \begin{multlined}[t] 
 \mathbb{H}(H|A) - \mathbb{H}(H) - \\
\left[ \mathbb{H}(H|\delta, A) - \mathbb{H}(H|\delta) \right]
\end{multlined} \\
