...
knitr::include_graphics(c("images/andy_temp/Left_Groove_1-100_Density_pointplot.png"))
```
...
```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/missing_value_1-100_Density_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/breakoff_1-100_Density_pointplot.png"))
```
