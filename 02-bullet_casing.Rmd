...
```{r,fig.align='center'}
knitr::include_graphics("images/cartridge_cases/4-26-21_Spotlight/samplingScheme_illustration.PNG")
```
...
```{r,fig.align='center'}
knitr::include_graphics("images/cartridge_cases/4-26-21_Spotlight/cmcCountDistributions_offsetCopies_randomRotation.png")
```
...
```{r,fig.align='center'}
knitr::include_graphics("images/cartridge_cases/4-26-21_Spotlight/estimatedAngles_sensofarGroup4_offsetCopies_randomRotation.png")
```
...
```{r,fig.align='center'}
knitr::include_graphics("images/cartridge_cases/4-26-21_Spotlight/convexCombinationAnimation.gif")
```
...
```{r,fig.align='center'}
knitr::include_graphics("images/cartridge_cases/4-26-21_Spotlight/sensofarGroup4_convexCombinationCMCCounts.png")
```
...
If we want to determine a value for the parameter `seg_length` (the length of a basis segment), we can compare the variance ratio value for different values of `seg_length`.
...
```{r, fig.cap="Residual Network Architecture.", fig.keep="hold", fig.align='center', out.height="30%"}
knitr::include_graphics(c("images/andy_temp/resnet_arch.png"))
```

```{r, fig.cap="Exponential Distribution.", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Exponential_Learning_Rate.png"))
```

```{r, fig.cap="Determining Learning Rate.", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Determing_Learning_Rate.png"))
```
...
```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/left_groove_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/right_groove_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/damage_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/No_Striations_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/vertical_change_in_striations_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/missing_value_Density_1-100_pointplot.png"))
```

```{r, fig.cap="Density plot using 100 LEAs", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/breakoff_Density_1-100_pointplot.png"))
```
...
```{r, fig.cap="Land Engraved Area Scan with assigned labels", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Resnet_latest_assigned_label.png"))
```



```{r, fig.cap="Land Engraved Area Scan with predicted labels", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Resnet_latest_prediction.png"))
```
...
Stochastic Gradient Descent performs a parameter update for each training example and associated label.
...
$$θ_t = θ_t − ε_t∇f(θ_t; x^i; y^i)$$

Stochastic Gradient Descent with warm restarts:

If we are stuck around a local minimum but have not found the global minimum we can encourage the model to jump local local minimums.

```{r, fig.cap="Cosine Annealing", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Explain_4.PNG"))
```



Expanding the tools for data processing, we can now identify and fill islands across the lea scan and obtain contour information.

```{r, fig.cap="", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/plot_1_prefill.PNG"))
```

```{r, fig.cap="", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/plot_2_fill_part1_correction.PNG"))
```

```{r, fig.cap="", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/plot_4_fill_part4_correction.PNG"))
```

```{r, fig.cap="", fig.keep="hold", fig.align='center', out.width="100%"}
knitr::include_graphics(c("images/andy_temp/Contour_Polygon_using_moores.PNG"))
```
